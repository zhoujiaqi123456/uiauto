...
class ParseExcel(object):
    ...
    def write_cell_value(self, row_no, col_no, value, style=None, sheet_name=None):
        ...
        if style is None:
            ...
            style = colors.COLOR_INDEX[2]
        elif style == "green":
            style = colors.COLOR_INDEX[3]
...
if __name__ == "__main__":
    excel = ParseExcel(r"C:\Users\a\PycharmProjects\ZheHe_UIAutomation/testData/测试数据.xlsx")
    ...
    # print(excel.write_cell_value(6,1,"德玛西亚","red"))
